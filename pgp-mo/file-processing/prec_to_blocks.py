...
small = gpd.read_file('./raw-from-source/tabblock2010_29_pophu/tabblock2010_29_pophu.shp')
large = gpd.read_file('./raw-from-source/tl_2013_29_bg/tl_2013_29_bg.shp')
...
agg.to_file('./output/blocks_with_bg/blocks_with_bg.shp')
