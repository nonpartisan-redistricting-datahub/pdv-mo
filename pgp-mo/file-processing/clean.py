...
# precinct data
prec_path = "./raw-from-source/mo_2016/mo_2016.shp"
...
uscong_path = "./raw-from-source/cb_2016_us_cd115_500k/cb_2016_us_cd115_500k.shp"
...
mscong = mscong.sort_values('id') #added by KA - assigns proper CD districts
mscong = mscong.reset_index(drop=True)
mscong_merging = mscong[["id", "geometry"]]

# state senate data
state_path = "./raw-from-source/tl_2016_29_sldu/tl_2016_29_sldu.shp"
...
block_group = gpd.read_file("./raw-from-source/tl_2013_29_bg/tl_2013_29_bg.shp")

# CVAP (block-group level)
# converted original file to utf-8 using
# iconv -c -f ascii -t utf-8 BlockGr.csv > BlockGr_8.csv
cvap = pd.read_csv("./raw-from-source/CVAP_2013-2017_ACS_csv_files/BlockGr_8.csv", encoding='utf-8')
...
blockgr.to_file("./output/blockgr_cvap/blockgr_cvap.shp")
...
# population
block_path = "./output/blocks_with_prec/mo_blocks_with_prec.shp"
...
prec = gpd.read_file("./output/mo_prec_labeled/mo_prec_labeled_nopop.shp")
...
out_file.to_file("./output/final_prec/prec_labeled.shp")

file = gpd.read_file("./output/final_prec/prec_labeled.shp")
